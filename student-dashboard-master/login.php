...
<body>
    <!--------- Main Navigation --------->
    <nav class="navbar navbar-expand-lg"style="background-color:#cc5500">
    ...
    background-color: #f7fbffbe "> 
        <div class="row">
            <div class="col-12">
                <h1 class="form-header" style="text-align: center; margin-top:30px;">Login Form</h1>   
                <p class="hint-text" style="text-align: center;margin-left:15px;">Please Enter Your Username and Password Below</p>
        ...
        <div class="container">
            ...
            <!--------- Cancel Button --------->
            <button style="margin-left: 570px; margin-top:15px;"type="submit" class="btn btn-cancel" onclick="cancel()">Cancel</button>
            <!--------- Register Button --------->  
            <input style="margin-top:15px;"type="submit" name="submit" class="btn btn-regis btn-md" value="Login"><br/>
            <!--------- Remember Me Button ---------> 
            <div class="remember"style="text-align:center; margin-top:10px;">
            <input  type="checkbox" name="remember" /> 
            <label class="center" for="remember-me">Remember Me?</label> 
            </div> 
            <!--------- Login Option --------->
            <p style="text-align:center; margin-left:12px; margin-bottom:30px;"class="centerr">Not registered yet? <a href="./register.php">Register</a></p>
        </div>
        </div>    
    </form>
