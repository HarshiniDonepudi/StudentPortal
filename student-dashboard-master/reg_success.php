...
<head>
    ...
    <meta name="description" content="PHP Registration Form Success">
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p style="text-align:center";>You can now log in to continue to your student portal! 🎓</p>
            
            <button style="margin-left:500px" class="btn btn-login"><a href="./login.php">Login</a></button>
        </div>
    </div>
