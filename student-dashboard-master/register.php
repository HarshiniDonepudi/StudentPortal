...
<body>
    ...
    background-color: #f7fbffbe ">
        <div class="row">
            <div class="col-12">
                <h1 style="text-align:center;margin-top:30px;"class="form-header">Registration Form</h1>
            </div>
        </div>
        <div class="container">
            <!--------- Username Input --------->
            ...
            <!--------- Cancel Button --------->
            <button style="margin-left:530px;" type="submit" class="btn btn-cancel" onclick="cancel()">Cancel</button>
            <!--------- Register Button --------->
            <button type="submit" class="btn btn-regis" value="Submit">Register</button>
            <!--------- Login Option --------->
            <p style="text-align:center; padding-bottom:30px; margin-right:10px;"class="center">Already a registered student? <a href="./login.php">Login</a></p>
        </div>
        </div>
    </form>
