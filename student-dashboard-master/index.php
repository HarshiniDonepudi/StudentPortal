...
<head>
    ...
    <meta name="description" content="PHP Registration Form Main">
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p style="text-align:center;">Please log in or register to continue! 🎓</p>
            
            <button class="btn btn-login" style="margin-left:440px;"><a href="./login.php">Login</a></button>
